...
// Covered by LGPL-2.0-or-later per the license coverage prelude in rpm/COPYING
...
// and rpmts.h from lib/, and rpmlog.h, rpmmacro.h and rpmkeyring.h from rpmio/.
// Their relocation does not change their provenance under RPM's LGPL exception.
...
#include <rpm/rpmmacro.h> // Macro configuration API
