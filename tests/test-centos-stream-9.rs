...
#[test]
fn test_centos_stream_9_find_glob() {
    common::assert_find_glob(&common::CENTOS_STREAM_9);
}

#[test]
fn test_centos_stream_9_find_regex() {
    common::assert_find_regex(&common::CENTOS_STREAM_9);
}

#[test]
fn test_centos_stream_9_find_regex_no_match() {
    common::assert_find_regex_no_match(&common::CENTOS_STREAM_9);
}
