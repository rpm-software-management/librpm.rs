...
pub enum Tag {
    ...
    SUGGESTSNAME = librpm_sys::rpmTag_e_RPMTAG_SUGGESTSNAME as isize,
    SUGGESTSVERSION = librpm_sys::rpmTag_e_RPMTAG_SUGGESTSVERSION as isize,
    SUGGESTSFLAGS = librpm_sys::rpmTag_e_RPMTAG_SUGGESTSFLAGS as isize,
    ENHANCESNAME = librpm_sys::rpmTag_e_RPMTAG_ENHANCESNAME as isize,
    ENHANCESVERSION = librpm_sys::rpmTag_e_RPMTAG_ENHANCESVERSION as isize,
    ENHANCESFLAGS = librpm_sys::rpmTag_e_RPMTAG_ENHANCESFLAGS as isize,
